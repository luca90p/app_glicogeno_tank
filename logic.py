...
def calculate_filling_factor_from_diet(weight_kg, cho_d1, cho_d2, s_fatigue, s_sleep, steps_m1, min_act_m1, steps_m2, min_act_m2):
    ...
    return combined_filling, final_diet_depletion_factor, avg_cho_gk, cho_d1_gk, cho_d2_gk
...
def simulate_metabolism(subject_data, duration_min, constant_carb_intake_g_h, cho_per_unit_g, crossover_pct, 
    ...
    # Setup Variabili Iniziali (Esattamente come nel backup)
    results = []
    ...
    for t in range(int(duration_min) + 1):
        ...
        # --- RIPARTIZIONE FONTI (MODELLO BACKUP ORIGINALE) ---
        
        # 1. Calcolo Domanda Totale CHO
        if is_lab_data:
        ...
        # 2. Muscle Fading (Il segreto della rampa)
